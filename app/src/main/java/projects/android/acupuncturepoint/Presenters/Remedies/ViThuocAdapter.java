...
public class ViThuocAdapter extends BaseAdapter {

    private List<ViThuoc> listData;
    private LayoutInflater layoutInflater;
    private Context context;

    public ViThuocAdapter(Context aContext, List<ViThuoc> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViThuoc viThuoc = this.listData.get(position);
        holder.vithuoc.setText(viThuoc.getName());
        holder.linkVithuoc.setText(viThuoc.getLink());
        return convertView;
    }
